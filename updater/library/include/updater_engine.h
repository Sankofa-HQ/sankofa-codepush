 ...
 */
SANKOFA_EXPORT void sankofa_free_string(const char *c_string);
 ...
 */
SANKOFA_EXPORT bool sankofa_should_auto_update(void);
 ...
 */
SANKOFA_EXPORT void sankofa_validate_next_boot_patch(void);
 ...
 * `sankofa_free_string`.
 */
SANKOFA_EXPORT char *sankofa_next_boot_patch_path(void);

/**
 * Start a thread to download an update if one is available.
 */
SANKOFA_EXPORT void sankofa_start_update_thread(void);
 ...
 */
SANKOFA_EXPORT void sankofa_report_launch_start(void);
 ...
 */
SANKOFA_EXPORT void sankofa_report_launch_failure(void);
 ...
 */
SANKOFA_EXPORT void sankofa_report_launch_success(void);
