...
class UpdaterBindings {
  ...
  int sankofa_current_boot_patch_number() {
    return _sankofa_current_boot_patch_number();
  }

  late final _sankofa_current_boot_patch_numberPtr =
      _lookup<ffi.NativeFunction<ffi.UintPtr Function()>>(
          'sankofa_current_boot_patch_number');
  late final _sankofa_current_boot_patch_number =
      _sankofa_current_boot_patch_numberPtr.asFunction<int Function()>();

  /// The patch number that will boot on the next run of the app, or 0 if there is
  /// no next patch.
  int sankofa_next_boot_patch_number() {
    return _sankofa_next_boot_patch_number();
  }

  late final _sankofa_next_boot_patch_numberPtr =
      _lookup<ffi.NativeFunction<ffi.UintPtr Function()>>(
          'sankofa_next_boot_patch_number');
  late final _sankofa_next_boot_patch_number =
      _sankofa_next_boot_patch_numberPtr.asFunction<int Function()>();
  ...
  bool sankofa_check_for_downloadable_update(
    ffi.Pointer<ffi.Char> c_channel,
  ) {
    return _sankofa_check_for_downloadable_update(
      c_channel,
    );
  }

  late final _sankofa_check_for_downloadable_updatePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>)>>(
          'sankofa_check_for_downloadable_update');
  late final _sankofa_check_for_downloadable_update =
      _sankofa_check_for_downloadable_updatePtr
  ...
  ffi.Pointer<UpdateResult> sankofa_update_with_result(
    ffi.Pointer<ffi.Char> c_channel,
  ) {
    return _sankofa_update_with_result(
      c_channel,
    );
  }

  late final _sankofa_update_with_resultPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<UpdateResult> Function(
              ffi.Pointer<ffi.Char>)>>('sankofa_update_with_result');
  late final _sankofa_update_with_result = _sankofa_update_with_resultPtr
  ...
  void sankofa_free_update_result(
    ffi.Pointer<UpdateResult> result,
  ) {
    return _sankofa_free_update_result(
      result,
    );
  }

  late final _sankofa_free_update_resultPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<UpdateResult>)>>(
          'sankofa_free_update_result');
  late final _sankofa_free_update_result = _sankofa_free_update_resultPtr
...
const int SANKOFA_UPDATE_ERROR = -1;

const int SANKOFA_NO_UPDATE = 0;

const int SANKOFA_UPDATE_INSTALLED = 1;

const int SANKOFA_UPDATE_HAD_ERROR = 2;

const int SANKOFA_UPDATE_IS_BAD_PATCH = 3;

const int SANKOFA_UPDATE_IN_PROGRESS = 4;
