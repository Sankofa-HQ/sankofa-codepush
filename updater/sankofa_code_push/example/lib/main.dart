...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    super.initState();
    // Check whether Sankofa is available.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Sankofa Code Push'),
      ),
      body: Column(
        children: [
          if (!_isUpdaterAvailable) const _SankofaUnavailable(),
          const Spacer(),
...
/// Widget that is mounted when Sankofa is not available.
class _SankofaUnavailable extends StatelessWidget {
  const _SankofaUnavailable();
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Text(
        '''
Sankofa is not available.
Please make sure the app was generated via `sankofa release` and that it is running in release mode.''',
