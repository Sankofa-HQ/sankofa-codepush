...
The Dart code in this library communicates with the Updater (part of Sankofa's
...
1. Android specific: be listed in
   https://github.com/sankofatech/flutter/blob/sankofa/dev/engine/src/flutter/shell/platform/android/android_exports.lst
