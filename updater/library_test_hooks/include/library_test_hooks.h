 ...
 */
SANKOFA_EXPORT void sankofa_test_reset(void);
 ...
 */
SANKOFA_EXPORT
bool sankofa_test_init(const char *app_storage_dir,
 ...
 */
SANKOFA_EXPORT void sankofa_test_simulate_successful_launch(void);
