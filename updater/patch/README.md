...
This is the tool used by the `sankofa` command line to package up a patch
file for uploading to Sankofa's servers.
...
which we save in Sankofa's database and then `library` validates that the
