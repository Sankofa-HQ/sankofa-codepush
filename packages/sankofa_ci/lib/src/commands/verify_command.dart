...
import 'package:sankofa_ci/src/dorny_filter.dart';
...
const dynamicCoverageMarker = '# sankofa_ci-managed: dynamic';
...
///   - **Dynamic**: a workflow that calls `sankofa_ci affected_packages`
...
class VerifyCommand extends Command<int> with RepoRootOption {
  ...
  void _printRequiredJobErrors(Map<String, _RequiredJobReport> errors) {
    ...
    stderr.writeln(
      ...
      'Re-run `sankofa_ci generate --required` to regenerate.',
    );
  }
  ...
  /// Substring-searching for `sankofa_ci affected_packages` would
