...
import 'package:sankofa_ci/src/codecov.dart';
import 'package:sankofa_ci/src/cspell.dart';
import 'package:sankofa_ci/src/git.dart';
import 'package:sankofa_ci/src/package_description.dart';
import 'package:sankofa_ci/src/pubspec.dart';
import 'package:sankofa_ci/src/repository_description.dart';
import 'package:sankofa_ci/src/workspace.dart' as workspace;
...
class RepositoryAnalyzer {
  ...
  static void _requireSafePath(String path) {
    ...
    throw FormatException(
      'sankofa_ci requires package paths to be portable POSIX paths '
