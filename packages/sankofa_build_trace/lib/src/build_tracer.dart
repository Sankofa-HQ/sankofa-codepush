...
import 'package:sankofa_build_trace/src/build_trace_event.dart';

/// Sankofa convention: all events from one producer share a single pid
...
class BuildTracer {
  ...
  /// emit with the same [id]. Sankofa convention uses the child's pid
