// Regeneration entrypoint for the sankofa_code_push_protocol package.
//
// Plugs a Sankofa-specific [FileRenderer] into space_gen's standard
...
// `lib/sankofa_code_push_protocol.dart`; those are hand-written and
// re-export the generated types.

import 'package:space_gen/space_gen.dart';

class SankofaFileRenderer extends FileRenderer {
  SankofaFileRenderer(super.config);
  ...
  @override
  String testBarrelImport() => 'sankofa_code_push_protocol.dart';
...
Future<int> main(List<String> arguments) =>
    runCli(arguments, fileRendererBuilder: SankofaFileRenderer.new);
