...
import 'package:sankofa_cli/src/executables/bundletool.dart';
...
void main() {
  group(SankofaAndroidArtifacts, () {
    ...
    setUp(() {
      ...
      sankofaAndroidArtifacts = SankofaAndroidArtifacts();
    });
    ...
    group('aarLibraryPath', () {
      test('returns path to AAR library', () {
        expect(
          runWithOverrides(() => SankofaAndroidArtifacts.aarLibraryPath),
    ...
    group('aarArtifactDirectory', () {
      test('returns path to AAR artifact directory', () {
        expect(
          runWithOverrides(
            () => SankofaAndroidArtifacts.aarArtifactDirectory(
              buildNumber: '1',
    ...
    group('aarArtifactPath', () {
      test('returns path to AAR artifact', () {
        final result = runWithOverrides(
          () => SankofaAndroidArtifacts.aarArtifactPath(
            packageName: 'com.example',
            buildNumber: '1',
          ),
        );
