...
import 'package:sankofa_cli/src/archive_analysis/archive_analysis.dart';
import 'package:sankofa_cli/src/archive_analysis/archive_differ.dart';
...
import 'package:sankofa_cli/src/cache.dart' show Cache;
...
import 'package:sankofa_cli/src/commands/release/releaser.dart';
...
class MockProcessResult extends Mock implements SankofaProcessResult {}
...
class MockSankofaAndroidArtifacts extends Mock
    implements SankofaAndroidArtifacts {}

class MockSankofaArtifacts extends Mock implements SankofaArtifacts {}

class MockSankofaCliCommandRunner extends Mock
    implements SankofaCliCommandRunner {}

class MockSankofaEnv extends Mock implements SankofaEnv {}

class MockSankofaFlutter extends Mock implements SankofaFlutter {}

class MockSankofaLogger extends Mock implements SankofaLogger {}

class MockSankofaProcess extends Mock implements SankofaProcess {}

class MockSankofaProcessResult extends Mock
    implements SankofaProcessResult {}

class MockSankofaValidator extends Mock implements SankofaValidator {}

class MockSankofaVersion extends Mock implements SankofaVersion {}

class MockSankofaYaml extends Mock implements SankofaYaml {}
