...
void main() {
  group(SankofaTracer, () {
    ...
    group('mergeInto', () {
      ...
      setUp(() {
        tempDir = Directory.systemTemp.createTempSync('sankofa_tracer_test_');
  ...
  group('sankofaTracerRef', () {
    test('resolves to a SankofaTracer inside a scope', () {
      final tracer = runScoped(
        () => sankofaTracer,
        values: {sankofaTracerRef},
      );
      expect(tracer, isA<SankofaTracer>());
    });
  });
}
