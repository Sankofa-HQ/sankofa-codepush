...
void main() {
  group(BuildTraceSummary, () {
    test('empty events → zero summary', () {
      ...
      expect(s.sankofaOverhead, isNull);
    ...
    test('android trace → nested gradle + android stats', () {
      ...
      final s = BuildTraceSummary.fromEvents(
        events,
        platform: 'android',
        sankofaOverhead: const Duration(milliseconds: 500),
      );

      // Top level
      expect(s.flutterBuild, const Duration(milliseconds: 3005));
      expect(s.sankofaOverhead, const Duration(milliseconds: 500));
      expect(s.total, const Duration(milliseconds: 3505));
      // sankofaLocal = overhead 500 − network 300 = 200
      expect(s.sankofaLocal, const Duration(milliseconds: 200));
