...
void main() {
  group(FlavorValidator, () {
    ...
    const sankofaYamlWithoutFlavors = SankofaYaml(appId: appId);
    const sankofaYamlWithFlavors = SankofaYaml(
      appId: appId,
      flavors: flavors,
    );
    ...
    group('validate', () {
      group('when project does not have flavors', () {
        setUp(() {
          ...
          ).thenReturn(sankofaYamlWithoutFlavors);
        });
      ...
      group('when project has flavors', () {
        setUp(() {
          when(
            () => sankofaEnv.getSankofaYaml(),
          ).thenReturn(sankofaYamlWithFlavors);
        });
