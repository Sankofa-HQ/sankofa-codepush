...
void main() {
  group(PatchCommand, () {
    ...
    setUp(() {
      ...
      when(() => sankofaEnv.usesSankofaCodePushPackage).thenReturn(false);
    ...
    group('confirmCreatePatch', () {
      ...
      group('when has link percentage', () {
        ...
        setUp(() {
          ...
          when(() => sankofaEnv.buildDirectory).thenReturn(buildDirectory);
...
Please re-run the release command for this version or create a new release.'''),
    ...
    group('when the target release does not contain the provided platform', () {
      ...
      test('logs error and exits with code 70', () async {
        ...
        verify(
          () => logger.err(
            '''No release exists for android in release version ${release.version}. Please run sankofa release android to create one.''',
          ),
        ).called(1);
      });
    });
