...
/// `sankofa flutter versions list`
/// List available Flutter versions.
/// {@endtemplate}
class FlutterVersionsListCommand extends SankofaCommand {
  ...
  Future<int> run() async {
    ...
    try {
      currentVersion = await sankofaFlutter.getVersionString();
    ...
    try {
      versions = await sankofaFlutter.getVersions();
      progress?.cancel();
