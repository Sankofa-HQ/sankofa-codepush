...
/// `sankofa account whoami`
/// Show the currently authenticated Sankofa user.
/// {@endtemplate}
class WhoamiCommand extends SankofaCommand {
  ...
  String get description =>
      ...
      '  Plan:           paid\n'
      '  Overage limit:  10000\n\n'
      'Plan is "paid" (active Sankofa subscription) or "free".\n'
      'Overage limit is the max pay-as-you-go patch installs allowed '
      'beyond your plan ("none" if unset).\n\n'
      '${SankofaCommand.jsonHint('sankofa account whoami --json')}';
