...
class AarReleaser extends Releaser {
  ...
  Future<void> assertPreconditions() async {
    ...
    if (sankofaEnv.androidPackageName == null) {
  ...
  Future<FileSystemEntity> buildReleaseArtifacts() async {
    ...
    final sourceLibraryDirectory = Directory(
      SankofaAndroidArtifacts.aarLibraryPath,
    );
    final targetLibraryDirectory = Directory(
      p.join(sankofaEnv.getSankofaProjectRoot()!.path, 'release'),
    );
  ...
  Future<void> uploadReleaseArtifacts({
    ...
    final extractedAarDir = await sankofaAndroidArtifacts.extractAar(
      packageName: sankofaEnv.androidPackageName!,
      buildNumber: buildNumber,
    ...
    await codePushClientWrapper.createAndroidArchiveReleaseArtifacts(
      ...
      aarPath: SankofaAndroidArtifacts.aarArtifactPath(
        packageName: sankofaEnv.androidPackageName!,
        buildNumber: buildNumber,
      ),
...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        mavenCentral()
+       maven {
+           url '../${p.basename(sankofaEnv.getSankofaProjectRoot()!.path)}/${p.relative(targetLibraryDirectory.path)}'
+       }
+       maven {
