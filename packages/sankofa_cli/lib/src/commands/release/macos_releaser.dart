...
class MacosReleaser extends Releaser with AppleReleaserMixin {
  ...
  Future<void> uploadReleaseArtifacts({
    ...
    await codePushClientWrapper.createMacosReleaseArtifacts(
      ...
      podfileLockHash: sankofaEnv.macosPodfileLockHash,
    );
...
${styleBold.wrap('Note:')} If you distribute your app via the Mac App Store using a .pkg installer, the packaging process may modify the binary and cause patch failures. See ${link(uri: Uri.parse('https://github.com/sankofatech/sankofa/issues/3223'))} for more information.
''';
}
