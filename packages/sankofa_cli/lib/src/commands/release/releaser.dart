...
abstract class Releaser {
  ...
  Directory get projectRoot => sankofaEnv.getSankofaProjectRoot()!;
  ...
  /// Instructions explaining next steps after running `sankofa release`. This
  ...
  /// passed either to Sankofa directly or forwarded to Flutter.
  bool get useObfuscation => argResults.flagPresent('obfuscate');

  /// DD table cascade byte threshold for the release build.
  ///
  /// Passed to Flutter tools via the SANKOFA_DD_MAX_BYTES environment
  ...
  /// 'ios'). Used to construct `build/<platformSubdir>/sankofa/`.
  ...
  // https://github.com/sankofatech/sankofa/issues/3630
