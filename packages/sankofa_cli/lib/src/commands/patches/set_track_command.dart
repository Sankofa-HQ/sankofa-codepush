...
/// Sample usage:
/// ```sh
/// sankofa patches set-track --release=1.0.0+1 --patch=1 --track=beta
/// ```
///
/// {@endtemplate}
class SetTrackCommand extends SankofaCommand {
  ...
  String get description =>
      ...
      '${SankofaCommand.jsonHint('sankofa patches set-track --release 1.0.0+1 --patch 1 --track stable --app-id <id> --json')}';
