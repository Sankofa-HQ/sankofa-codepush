...
/// `sankofa patches list`
/// List patches for a release.
/// {@endtemplate}
class PatchesListCommand extends SankofaCommand {
  ...
  String get description =>
      ...
      '${SankofaCommand.jsonHint('sankofa patches list --release-version 1.0.0+1 --app-id <id> --json')}';
