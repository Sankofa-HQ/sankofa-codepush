...
import 'package:sankofa_cli/src/formatters/file_size_formatter.dart';
...
/// `sankofa patches info`
/// Show details for a specific patch.
/// {@endtemplate}
class PatchesInfoCommand extends SankofaCommand {
  ...
  String get description =>
      ...
      '    ios      arm64        896 KB\n\n'
      '${SankofaCommand.jsonHint('sankofa patches info --release-version 1.0.0+1 --patch-number 1 --app-id <id> --json')}';
