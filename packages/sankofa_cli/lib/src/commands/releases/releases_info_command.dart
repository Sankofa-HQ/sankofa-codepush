...
/// `sankofa releases info`
/// Show details for a specific release.
/// {@endtemplate}
class ReleasesInfoCommand extends SankofaCommand {
  ...
  String get description =>
      ...
      '    macos:    active\n'
      '    windows:  active\n\n'
      '${SankofaCommand.jsonHint('sankofa releases info --release-version 1.0.0+1 --app-id <id> --json')}';
