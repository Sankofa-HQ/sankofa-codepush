...
class MacosPatcher extends Patcher
  ...
  String get _arm64AotOutputPath =>
      p.join(sankofaEnv.buildDirectory.path, 'out.arm64.aot');

  // The elf snapshot built for Intel macs.
  String get _x64AotOutputPath =>
      p.join(sankofaEnv.buildDirectory.path, 'out.x64.aot');
  ...
  @override
  String? get localPodfileLockHash => sankofaEnv.macosPodfileLockHash;
...
For more information see: ${supportedFlutterVersionsUrl.toLink()}''');
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: SankofaArtifact.genSnapshotMacosArm64,
      additionalArgs: [
    ...
    await artifactBuilder.buildElfAotSnapshot(
      ...
      genSnapshotArtifact: SankofaArtifact.genSnapshotMacosX64,
      additionalArgs: [
        ...ApplePatcherMixin.splitDebugInfoArgs(splitDebugInfoPath),
        ...obfuscationGenSnapshotArgs,
      ],
