...
Entries from "--dart-define" with identical keys take precedence over entries from these files.''',
  ...
  /// An argument that allows the user to specify a Sankofa app ID directly,
  /// bypassing the app ID in sankofa.yaml.
  static const appIdArg = ArgumentDescriber(
    name: 'app-id',
    description:
        'The Sankofa app ID to use. Overrides the app ID in '
        'sankofa.yaml (e.g. "your-app-id").',
  );
