...
import 'package:sankofa_cli/src/metadata/build_environment_metadata.dart';
...
class CreatePatchMetadata extends Equatable {
  ...
  ///
  /// Reason: sankofa does not support asset changes in patches, and knowing
  ...
  ///
  /// Reason: sankofa does not support native code changes in patches, and
  /// knowing that native code changes were detected can help explain unexpected
  /// behavior in a patch.
  final bool hasNativeChanges;

  /// Whether the release version had to be inferred by Sankofa because
