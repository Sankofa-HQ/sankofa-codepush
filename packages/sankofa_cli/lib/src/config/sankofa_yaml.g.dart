...
part of 'sankofa_yaml.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SankofaYaml _$SankofaYamlFromJson(Map json) => $checkedCreate(
  'SankofaYaml',
  json,
  ($checkedConvert) {
    $checkKeys(
...
Map<String, dynamic> _$SankofaYamlToJson(
  SankofaYaml instance,
) => <String, dynamic>{
