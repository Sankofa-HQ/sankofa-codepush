...
/// permission, which is required for Sankofa to work.
///
/// See https://github.com/sankofatech/sankofa/issues/160.
...
The command you are running must be run within a Flutter app project that supports the Android platform. If you are releasing a Flutter module, use 'aar' in place of 'android' in your sankofa command.''';
  // coverage:ignore-end
