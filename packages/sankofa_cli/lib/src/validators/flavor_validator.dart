...
/// Verifies that the flavors in the Sankofa configuration match the
...
class FlavorValidator extends Validator {
  ...
  Future<List<ValidationIssue>> validate() async {
    ...
    final projectFlavors = sankofaYaml.flavors;
...
The default app id ${sankofaYaml.appId} will be used.''',
        ),
      ];
    }
