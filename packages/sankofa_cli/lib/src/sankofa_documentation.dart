...
/// Link to the Sankofa documentation page.
const docsUrl = 'https://docs.sankofa.dev';

/// Link to the Flutter version page on the Sankofa documentation.
const flutterVersionUrl = '$docsUrl/getting-started/flutter-version';

/// Link to the supported Flutter versions section on the Sankofa
/// documentation.
const supportedFlutterVersionsUrl =
    '$flutterVersionUrl#supported-flutter-versions';

/// Link to the troubleshooting page on the Sankofa documentation.
...
/// Link to the troubleshooting section which covers the
/// not being able to run the app in VS Code after installing Sankofa.
