...
class BuildTraceSession {
  ...
  /// The wall-clock time at which the current `sankofa` invocation began.
  final DateTime commandStartedAt;

  /// The Chrome Trace Event Format JSON file that producers
  /// (`flutter build --sankofa-trace`, `aot_tools --trace`, and
  /// sankofa_cli's own spans) append to. Null when tracing is not
