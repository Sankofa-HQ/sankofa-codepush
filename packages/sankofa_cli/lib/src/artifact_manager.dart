...
/// Manages artifacts for the Sankofa CLI.
class ArtifactManager {
  ...
  static Directory? androidArchsDirectory({
    ...
    //
    // See https://github.com/sankofatech/sankofa/issues/1798
  ...
  /// Returns the sankofa release supplement directory for the given
  ...
  Directory? getReleaseSupplementDirectory({
    ...
    // Sankofa-built engine's gen_snapshot writes AOT link metadata
    // (App.ct.link / App.dt.link / App.ft.link) into build/<platform>/sankofa
    // once Phase 1 codepush patches land. Function returns null gracefully
    // if the dir doesn't exist (e.g. Phase 0 builds where supplements aren't
    // generated yet).
  ...
  /// Returns the path to the sankofa release supplement directory for iOS.
  ///
  ...
  /// Returns the path to the sankofa release supplement directory for macOS.
  ///
  /// Returns null if there is no supplement directory
  /// (e.g. when using older Flutter revisions).
  ...
  /// Name of the App.xcframework generated by `sankofa release ios-framework`
  static const String appXcframeworkName = 'App.xcframework';

  /// Returns the path to the App.xcframework generated by
  /// `sankofa release ios-framework` or
  /// `sankofa patch ios-framework`.
