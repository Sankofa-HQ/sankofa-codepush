...
import 'package:sankofa_cli/src/extensions/file.dart';
...
extension OptionFinder on ArgResults {
  ...
  ///
  /// Use this for flags that Sankofa and Flutter both understand
...
extension ForwardedArgs on ArgResults {
  ...
  /// A list of arguments parsed by Sankofa commands that will be forwarded
