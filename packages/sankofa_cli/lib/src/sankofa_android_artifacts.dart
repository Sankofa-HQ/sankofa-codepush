...
/// The reference to the [SankofaAndroidArtifacts] instance.
final sankofaAndroidArtifactsRef = create(SankofaAndroidArtifacts.new);

/// The [SankofaAndroidArtifacts] instance available in the current zone.
SankofaAndroidArtifacts get sankofaAndroidArtifacts =>
    read(sankofaAndroidArtifactsRef);

/// Mixin on [SankofaCommand] which exposes methods
// to find the artifacts generated for android
class SankofaAndroidArtifacts {
