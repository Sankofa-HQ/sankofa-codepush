...
/// (e.g. "doctor" for `sankofa doctor`, "patch ios" for `sankofa patch ios`).
///
/// Returns `null` when no subcommand was recognized (bare `sankofa` invocation).
