...
import 'package:sankofa_code_push_client/src/version.dart';
...
/// Dart client for the Sankofa CodePush API.
/// {@endtemplate}
class CodePushClient {
  ...
  CodePushClient({
    ...
    Map<String, String>? customHeaders,
       ...
       hostedUri = hostedUri ?? Uri.https('api.sankofa.dev');
  ...
  /// The hosted uri for the Sankofa CodePush API.
  final Uri hostedUri;
  ...
  /// Create a new Sankofa user with the provided [name].
  ///
