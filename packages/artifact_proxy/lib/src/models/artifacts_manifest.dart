...
class ArtifactsManifest {
  ...
  /// The storage bucket that contains the sankofa artifacts.
  final String storageBucket;

  /// The list of sankofa artifacts that should be overridden.
