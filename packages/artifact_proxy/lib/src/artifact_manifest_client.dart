...
/// A client that fetches [ArtifactsManifest]s from the sankofa storage bucket
...
class ArtifactManifestClient {
  ...
  Future<ArtifactsManifest> _fetchManifest(String revision) async {
    final url = Uri.parse(
      'https://storage.googleapis.com/download.sankofa.dev/sankofa/$revision/artifacts_manifest.yaml',
    );
